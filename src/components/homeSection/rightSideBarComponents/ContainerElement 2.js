...
const ContainerElement2 = () => {
  return (
    <div className="relative h-[60px]  p-2 pr-0 my-4">
        <img src ={require('../../../assets/tn.png')}className=" ml-4 bg-blue-400 inline-block h-full w-[44px]  mr-2 rounded-lg"></img>
      <div className="inline-block h-full align-top ml-4">
        <div className="h-[50%] text-md font-normal font-sans">Tunisia</div>
