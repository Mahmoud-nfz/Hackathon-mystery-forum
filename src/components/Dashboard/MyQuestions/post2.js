...
const Post2 = () => {
 ...
 return (
     ...
     >
      ...
      <img src={require('../../../assets/earth.jpeg')} className="mt-4 inline-block align-top rounded-2xl h-[calc(17vw-32px)]  w-[calc(17vw-32px)]"></img>
      ...
      <div className=" inline-block h-fit w-[calc(100%-17vw+32px)] px-4">
       <div className=" w-full h-full relative">
        ...
        <div className="h-fit w-[70%] text-base text-[#777777] p-2">
         Thousands dead, millions displaced: the earthquake fallout in Turkey and Syria. Death toll of 47,000 expected to rise and WHO says 26 million...
        </div>
